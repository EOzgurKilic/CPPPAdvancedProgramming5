...
class Program
{
    static void Main(string[] args)
    {
        ...
        //In short, apart from utilizing from polymorphism or explicit&implicit conversions; there is no way to assign an instance to a different type reference point.
